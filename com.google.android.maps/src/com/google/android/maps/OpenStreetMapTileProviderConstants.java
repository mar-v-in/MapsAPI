...
public interface OpenStreetMapTileProviderConstants {
	...
	public static final File OPENMAPS_PATH = new File(
			Environment.getExternalStorageDirectory(), ".openmaps");

	/** Base path for tiles. */
	public static final File TILE_PATH_BASE = new File(OPENMAPS_PATH, "tiles");
