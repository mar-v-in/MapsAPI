...
public class ScaleBarOverlay extends Overlay implements GeoConstants {
	...
	public ScaleBarOverlay(final Context context,
		...
		if ("motorola".equals(manufacturer)
			...
			final WindowManager windowManager = (WindowManager) this.context
					.getSystemService(Context.WINDOW_SERVICE);
			if (windowManager.getDefaultDisplay().getOrientation() > 0) {
				xdpi = (float) (screenWidth / 3.75);
				ydpi = (float) (screenHeight / 2.1);
			} else {
				xdpi = (float) (screenWidth / 2.1);
				ydpi = (float) (screenHeight / 3.75);
			}
